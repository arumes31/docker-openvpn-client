...
```
docker pull ghcr.io/arumes31/docker-openvpn-client:latest
```
...
services:
  openvpn-client:
    image: ghcr.io/arumes31/docker-openvpn-client:latest
...
Once you have container running `ghcr.io/arumes31/docker-openvpn-client:latest`, run the following command to spin up a temporary container using `openvpn-client` for networking.
